...
urlpatterns = [
    ...
    path('news-ticker/', views.news_ticker_list, name='news_ticker_list'),
    path('news-ticker/<int:pk>/toggle/', views.news_ticker_toggle, name='news_ticker_toggle'),
    path('news-ticker/<int:pk>/delete/', views.news_ticker_delete, name='news_ticker_delete'),
    ...
    path('courses/', views.courses_and_fees, name='courses'),
    ...
    path('attendance/mark/<int:grade_id>/', views.mark_attendance_class, {'division_id': 0}, name='mark_attendance_grade'),
    ...
    path('examination/dashboard/', views.examination_dashboard, name='examination_dashboard'),
    ...
    path('certificates/acknowledgement/', views.acknowledgement_certificate, name='acknowledgement_certificate'),
    path('certificates/acknowledgement/<int:pk>/', views.acknowledgement_certificate, name='acknowledgement_certificate_student'),
    path('certificates/acknowledgement/<int:pk>/pdf/', views.acknowledgement_certificate_pdf, name='acknowledgement_certificate_pdf'),
    ...
    path('attendance/monthly/grid/<int:grade_id>/<int:division_id>/', views.monthly_attendance_grid, name='monthly_attendance_grid'),
    ...
    path('credentials/students/bulk-reset/', views.student_credential_bulk_reset, name='student_credential_bulk_reset'),
